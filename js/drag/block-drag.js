/**
 * drag/block-drag.js — Drag & drop блоков внутри редактора
 * Зависит от: snapshotEditor, updateEditorEmptyState (core),
 *             showNotification (ui — пока в editor.js)
 */
...
function performDrop(clientX, clientY) {
    ...
    snapshotEditor('before-drag-drop');
...
window.initDragForElement = initDragForElement;
window.initDragAndDrop = initDragAndDrop;
window.setupDragObserver = setupDragObserver;
window.setupNestedDragAreas = setupNestedDragAreas;
